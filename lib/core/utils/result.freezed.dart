...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T value)?  ok,TResult Function( AppError error)?  err,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Ok() when ok != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T value)  ok,required TResult Function( AppError error)  err,}) {final _that = this;
switch (_that) {
case Ok():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T value)?  ok,TResult? Function( AppError error)?  err,}) {final _that = this;
switch (_that) {
case Ok() when ok != null:
return ok(_that.value);case Err() when err != null:
return err(_that.error);case _:
